      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="space-y-8 text-sm leading-relaxed text-ivory/75 sm:text-base">
          <section className="space-y-3">
            <h2 className="font-serif text-2xl text-ivory">1. Giriş</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-serif text-2xl text-ivory">4. Saklama süresi</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-serif text-2xl text-ivory">5. Üçüncü taraflar</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-serif text-2xl text-ivory">6. Haklarınız</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="font-serif text-2xl text-ivory">7. İletişim</h2>
            <p>
