...
export function ContactCTA() {
  return (
    <section className="relative overflow-hidden border-t border-gold/20 bg-cream px-4 py-20 sm:px-6 sm:py-24 lg:px-8">
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(201,162,75,0.14),transparent_65%)]"
      />
      <motion.div
      ...
      >
        ...
        <p className="mt-5 max-w-lg text-sm leading-relaxed text-charcoal/70 sm:text-base">
